...
class STWave(nn.Module):
    def __init__(self, input_dims, output_dims,
        ...
        self.end_emb = FeedForward([features, features, output_dims])
        self.end_emb_l = FeedForward([features, features, output_dims])
    ...
    def forward(self, X):
        ...
        hat_y = hat_y.permute(0, 2, 3, 1)
        hat_y_l = hat_y_l.permute(0, 2, 3, 1)
